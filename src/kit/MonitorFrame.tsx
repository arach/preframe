 ...
 *
 * Ported from premotion with two kit defaults flipped:
 *   - showStand = false (we're not selling a desk shot)
 *   - powerOnEffect = false (cross-dissolves between clips replace the
 *     power-on flash that worked for single-clip openers)
 *
 * The bezel + screen-glow + wordmark chin combo gives the source video a
 * "real screen" feel without being skeumorphic. Use a low-saturation
 * glowColor for the calm aesthetic.
 */
...
export const MonitorFrame: React.FC<MonitorFrameProps> = ({
  ...
  powerOnEffect = false,
  wordmark = '',
  wordmarkColor = 'rgba(255, 255, 255, 0.22)',
  bgColor = BG,
  screenRadius = 6,
  monitorWidthPct = 96,
  monitorHeightPct = 80,
        ...
        {showStand && (
          <div
            style={{
              width: 50,
              height: standHeight,
              background: `linear-gradient(90deg, ${standColor} 0%, rgba(55,55,60,1) 50%, ${standColor} 100%)`,
