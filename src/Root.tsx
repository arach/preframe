...
import { HermesDemo, HERMES_DEMO_FRAMES } from "./projects/hermes-demo/HermesDemo";
import { FilmBurn } from "./components/FilmBurn";
import { MetricPop } from "./components/MetricPop";
  ...
  return (
    <>
      ...
      <Folder name="Lattices">
        ...
        />
        {/* Hermes FX Demo — glass panels, holographic, CA, grain, grade */}
        <Composition
          id="HermesDemo"
      ...
      <Folder name="Treatments">
        <Composition
          ...
          width={WIDTH}
          height={HEIGHT}
          defaultProps={{ grainStrength: 0.30, vignetteAmount: 0.55, tint: 'warm' as const }}
        />
        <Composition
          id="MetricPop"
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          component={MetricPop as any}
          durationInFrames={Math.round(4 * FPS)}
          fps={FPS}
          width={WIDTH}
          height={HEIGHT}
          defaultProps={{ value: 10000, label: 'active users', prefix: '', suffix: '' }}
        />
        <Composition
          id="DeviceFrame"
          component={() => <DeviceFrame device="iphone" colorScheme="dark"><div style={{ width: '100%', height: '100%', background: '#111' }} /></DeviceFrame>}
          durationInFrames={5 * FPS}
          fps={FPS}
          width={1080}
          height={1920}
        ...
        <Composition
          id="SocialReel"
          component={() => <SocialReel title="DEMO" handle="@arach"><div style={{ width: '100%', height: '100%', background: '#111' }} /></SocialReel>}
          durationInFrames={10 * FPS}
          fps={FPS}
          width={1080}
          height={1920}
        ...
        <Composition
          id="ChapterSlate"
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          component={ChapterSlate as any}
          durationInFrames={4 * FPS}
          fps={FPS}
          width={WIDTH}
          height={HEIGHT}
          defaultProps={{ chapter: 1, title: 'Introduction', subtitle: '' }}
        />
        <Composition
          id="KineticTitle"
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          component={KineticTitle as any}
          durationInFrames={6 * FPS}
          fps={FPS}
          width={WIDTH}
          height={HEIGHT}
          defaultProps={{ lines: ['BUILT FOR', 'THE PEOPLE', 'WHO SHIP'], accentLineIndex: 2 }}
        />
      </Folder>
